...
A modern Transformers.js chat application powered by [@browser-ai/transformers-js](https://github.com/jakobhoeg/browser-ai) and [Vercel AI SDK](https://ai-sdk.dev/).
